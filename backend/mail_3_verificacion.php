<?php
 ...
 header("Access-Control-Allow-Headers: Content-Type, Access-Control-Allow-Headers, Authorization, X-Requested-With");
    ...
    $email=$data->email;
    $codigo_verif=$data->codigo_verif;
...
if (empty($email)) {
    ...
    try {
        ...
        $mail->Subject = 'Verificacion de Correo MEDi';
        ...
        <p style="color: #ff7832; font-weight: bold;">Utiliza el siguiente código para Verificar tu Correo Electrónico:</p><br>
        <h1 style="font-weight: bold;">'.$codigo_verif.'</h1>
        </div>';
